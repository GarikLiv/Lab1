...
We took the dataset of $I_c \text{ vs }V_{be}$ and fitted it to \ref{eq4}.
...
We then performed a weighted least square analysis on \ref{eq7} with the variance of $V_T$ found from curve fit.We expected the slope to equal $\frac{k}{e}$. We performed this analysis for both the silicon and germanium transistor data. 
...
As our range of temperatures [296K,316K] was small, we performed a least squares analysis on \ref{eq6}
